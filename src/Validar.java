...
public class Validar extends ReadFile{
    ...
    public Validar(ArrayList<String> sig, ArrayList<String> f, ArrayList<String> state, HashMap<String, String> t) {
        super(sig, f, state, t);
        this.sig = sig;
        this.f = f;
        this.state = state;
    ...
    public void Leer() {
        ...
        try {
            ...
            System.out.println(key);System.out.println(transicion);System.out.println(newKey);Input(key.get(0));
        }catch (Exception e){
